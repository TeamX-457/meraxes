...
const Control = () => {
  return (
    <div className="  min-h-screen flex items-center justify-center p-6 md:p-12 lg:p-20">
      <div className="max-w-7xl w-full flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-10">
          <div>
            ...
            <h2 className="font-body text-base md:text-lg">
              Adjust model speed, intent threshold, and FAQ weighting per bot.
              Live retraining, source control on every change.
            </h2>
          </div>

          <div className="flex w-full justify-between border-b border-foreground pb-4 items-center">
            <h1 className="text-foreground/60 font-medium">Inference latency</h1>
        ...
        <div className="w-full lg:w-1/2 aspect-square max-w-120 border border-[#21262d] rounded-2xl bg-accent-background flex items-center justify-center shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
          <div className="w-16 h-16 rounded-full border border-primary/30  flex items-center justify-center shadow-[0_0_30px_rgba(30,157,241,0.15)]">
